        ...
        try:
            ...
            if pan_vat_certificate_data:
                organization_kyc.PAN_VAT_certificate.save(
                    self.extension(pan_vat_certificate_data),
            ...
            notification_data = {
                ...
                "title": "KYC Registration Successful",
                "message": "A new request has been made for KYC registration.",
            }
            send_notification(user=self.instance, notification_data=notification_data)
