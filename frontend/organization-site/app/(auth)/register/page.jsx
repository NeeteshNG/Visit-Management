...
export default function Register() {
  ...
  return (
    <div
      id="container"
      className="grid px-5 py-2 mx-auto overflow-y-scroll xl:px-32 md:grid-cols-2 font-inter max-w-9xl"
    >
                  ...
                  <div className="mt-2.5 relative">
                    <BuildingIcon
                      className={`absolute text-2xl left-4 ${
                        errors.organization_name ? "top-1/3" : "top-1/2"
                ...
                <div className="w-full gap-2">
                  <section>
                    ...
                    <div className="mt-2.5 relative">
                      ...
                      <BagIcon
                        className={`absolute text-2xl left-4 ${
                          errors.organization_type ? "top-1/3" : "top-1/2"
                        } transform -translate-y-1/2 text-gray-400`}
                      />
