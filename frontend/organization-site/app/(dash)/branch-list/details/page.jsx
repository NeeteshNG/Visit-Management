...
export default function BranchDetails() {
  ...
  useEffect(() => {
    getorgbranchdetails({
      toast: toast,
      setbranchesdetails: setgetbranchdetails,
      id: data.get("id"),
    });
  }, [data]);
      ...
      {getbranchdetail === null ? (
        ...
        <div className="flex justify-between w-[100%]">
          <ShareDialog
            ...
            open={open}
            url={`${baseurl}${getbranchdetail.qr_image}`}
          />
          <div className="flex flex-col lg:w-[70%] w-[1100px] bg-white p-8 shadow-md rounded-md">
            <p className="font-bold text-2xl font-inter">
              {getbranchdetail.district} Branch
            </p>
            <div className="flex gap-16 mt-6">
              <div className="mt-6 space-y-4">
                <LineComponent
                  Icon={TbTopologyStar}
                  subtext={getbranchdetail.name}
                  text="Branch Name"
                />
                <LineComponent
                  Icon={CiCalendar}
                  subtext={formatTimestamp(getbranchdetail.created_at)}
                  text="Created At"
                />
                <LineComponent
                  Icon={BsPerson}
                  subtext={getbranchdetail.contact_person}
                  text="Contact Person"
                />
                <LineComponent
                  Icon={FaMobileScreen}
                  subtext={getbranchdetail.branch_no}
                  text="Branch Contact No."
                />
              ...
              <div className="mt-6 space-y-4">
                <LineComponent
                  Icon={CiFlag1}
                  subtext={getbranchdetail.country}
                  text="Country"
                />
                <LineComponent
                  Icon={MdLocationSearching}
                  subtext={getbranchdetail.state}
                  text="State/Province"
                />
                <LineComponent
                  Icon={MdShareLocation}
                  subtext={getbranchdetail.district}
                  text="District"
                />
                <div className="flex gap-2 items-center">
                ...
                <LineComponent
                  Icon={TbLocation}
                  subtext={getbranchdetail.city_village_area}
                  text="Address"
                />
              </div>
            </div>
          ...
          <div className="lg:w-[28%]">
            <div className=" w-full shadow-lg bg-white rounded-lg h-[599px] flex items-center justify-center flex-col p-4">
              ...
              <div className=" text-center   border-ngtryprimary w-[240px] mt-9 h-[302px] border-[8px] rounded-2xl p-4  ">
                ...
                <div>
                  <Image
                    src={`${baseurl}${getbranchdetail.qr_image}`}
                    alt="soemt"
                    height={180}
                    width={180}
                  />
                ...
                <div className="terminal-no text-center mt-35px text-black">
                  ...
                  <p className="terminal-number font-bold text-black mt-12px text-base font-inter">
                    {getbranchdetail.id}
                  </p>
                </div>
              </div>
              <p className="font-bold text-3xl font-inter mt-4 text-center">
                {getbranchdetail.district} Branch
              </p>
              <p className="font-normal text-base font-inter mt-2">
                {getbranchdetail.district},{getbranchdetail.country}
              </p>
