              ...
              <>
                <div className="w-[600px]">
                  ...
                  <div className="mt-[8px] relative">
                    ...
                    <DropDownIcon className="absolute right-2 top-1/2 transform -translate-y-1/2 text-2xl text-gray-700" />
                    <PurposeIcon
                ...
                {selectedPurpose === "Others" && (
                  <div className="w-[600px]">
                    ...
                    <div className="mt-[8px] relative">
                      <OtherPurposeIcon className="absolute left-4 top-1/2 transform -translate-y-1/2 text-2xl text-gray-400" />
