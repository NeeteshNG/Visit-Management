              ...
              notificationData.slice(0, 8).map(notification => (
                ...
                >
                  <div className='flex-shrink-0 '>
                    <div className='absolute flex items-center justify-center w-5 h-5 -mt-0 -ml-3 bg-ngtryprimary border border-white rounded-full dark:border-gray-800'>
                      <svg
                  ...
                  <div className='w-full pl-3'>
                    ...
                    <div className='text-xs text-ngtryprimary dark:text-ngtrysage'>
